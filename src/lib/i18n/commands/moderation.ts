...
export default {
  Kick: {
    ...
    reasonFieldDescription: T("commands/moderation:kick.reasonFieldDescription"),
  ...
  Ban: {
    ...
    durationFieldDescription: T("commands/moderation:ban.durationFieldDescription"),
    deleteMessagesFieldName: T("commands/moderation:ban.deleteMessagesFieldName"),
    deleteMessagesFieldDescription: T("commands/moderation:ban.deleteMessagesFieldDescription"),
    title: T("commands/moderation:ban.title"),
    desc: FT<{ user: string }>("commands/moderation:ban.desc"),
    descWithReason: FT<{ user: string; reason: string }>("commands/moderation:ban.descWithReason"),
    descTemp: FT<{ user: string; duration: string }>("commands/moderation:ban.descTemp"),
  ...
  Unban: {
    ...
    userIdFieldDescription: T("commands/moderation:unban.userIdFieldDescription"),
    reasonFieldName: T("commands/moderation:unban.reasonFieldName"),
    reasonFieldDescription: T("commands/moderation:unban.reasonFieldDescription"),
    title: T("commands/moderation:unban.title"),
    desc: FT<{ user: string }>("commands/moderation:unban.desc"),
    descWithReason: FT<{ user: string; reason: string }>("commands/moderation:unban.descWithReason"),
  },
  Mute: {
    ...
    durationFieldDescription: T("commands/moderation:mute.durationFieldDescription"),
    reasonFieldName: T("commands/moderation:mute.reasonFieldName"),
    reasonFieldDescription: T("commands/moderation:mute.reasonFieldDescription"),
    title: T("commands/moderation:mute.title"),
    desc: FT<{ user: string; duration: string }>("commands/moderation:mute.desc"),
    descWithReason: FT<{ user: string; duration: string; reason: string }>("commands/moderation:mute.descWithReason"),
  ...
  Unmute: {
    ...
    reasonFieldDescription: T("commands/moderation:unmute.reasonFieldDescription"),
    title: T("commands/moderation:unmute.title"),
    desc: FT<{ user: string }>("commands/moderation:unmute.desc"),
    descWithReason: FT<{ user: string; reason: string }>("commands/moderation:unmute.descWithReason"),
  },
  Warn: {
    ...
    reasonFieldDescription: T("commands/moderation:warn.reasonFieldDescription"),
    amountFieldName: T("commands/moderation:warn.amountFieldName"),
    amountFieldDescription: T("commands/moderation:warn.amountFieldDescription"),
    advancedFieldName: T("commands/moderation:warn.advancedFieldName"),
    advancedFieldDescription: T("commands/moderation:warn.advancedFieldDescription"),
    subcommandListName: T("commands/moderation:warn.subcommandListName"),
    subcommandListDescription: T("commands/moderation:warn.subcommandListDescription"),
    subcommandRemoveName: T("commands/moderation:warn.subcommandRemoveName"),
    subcommandRemoveDescription: T("commands/moderation:warn.subcommandRemoveDescription"),
    subcommandLevelName: T("commands/moderation:warn.subcommandLevelName"),
    subcommandLevelDescription: T("commands/moderation:warn.subcommandLevelDescription"),
    subcommandSetName: T("commands/moderation:warn.subcommandSetName"),
    subcommandSetDescription: T("commands/moderation:warn.subcommandSetDescription"),
    subcommandMultiName: T("commands/moderation:warn.subcommandMultiName"),
    subcommandMultiDescription: T("commands/moderation:warn.subcommandMultiDescription"),
    ...
    caseIdFieldDescription: T("commands/moderation:warn.caseIdFieldDescription"),
    title: T("commands/moderation:warn.title"),
    desc: FT<{ user: string; amount: string }>("commands/moderation:warn.desc"),
    descWithReason: FT<{ user: string; reason: string; amount: string }>("commands/moderation:warn.descWithReason"),
    ...
    heavywarnCommandDescription: T("commands/moderation:warn.heavywarnCommandDescription"),
    listTitle: FT<{ user: string }>("commands/moderation:warn.listTitle"),
    listEmpty: T("commands/moderation:warn.listEmpty"),
    listEntry: FT<{ id: string; reason: string; expiry: string }>("commands/moderation:warn.listEntry"),
  },
  WarnSettings: {
    commandName: T("commands/moderation:warnSettings.commandName"),
    commandDescription: T("commands/moderation:warnSettings.commandDescription"),
    subcommandActionsName: T("commands/moderation:warnSettings.subcommandActionsName"),
    subcommandActionsDescription: T("commands/moderation:warnSettings.subcommandActionsDescription"),
    subcommandRolesName: T("commands/moderation:warnSettings.subcommandRolesName"),
    subcommandRolesDescription: T("commands/moderation:warnSettings.subcommandRolesDescription"),
    subcommandPresetName: T("commands/moderation:warnSettings.subcommandPresetName"),
    subcommandPresetDescription: T("commands/moderation:warnSettings.subcommandPresetDescription"),
    quickstartCommandName: T("commands/moderation:warnSettings.quickstartCommandName"),
    quickstartCommandDescription: T("commands/moderation:warnSettings.quickstartCommandDescription"),
    ...
    expiryFieldDescription: T("commands/moderation:warnSettings.expiryFieldDescription"),
    dmFieldName: T("commands/moderation:warnSettings.dmFieldName"),
    dmFieldDescription: T("commands/moderation:warnSettings.dmFieldDescription"),
    dmEnabled: T("commands/moderation:warnSettings.dmEnabled"),
    dmDisabled: T("commands/moderation:warnSettings.dmDisabled"),
    logChannelFieldName: T("commands/moderation:warnSettings.logChannelFieldName"),
    logChannelFieldDescription: T("commands/moderation:warnSettings.logChannelFieldDescription"),
    ...
    presetStrictStrike: T("commands/moderation:warnSettings.presetStrictStrike"),
  ...
  Case: {
    ...
    actionTypeFieldDescription: T("commands/moderation:case.actionTypeFieldDescription"),
  ...
  Note: {
    ...
    subcommandAddDescription: T("commands/moderation:note.subcommandAddDescription"),
    subcommandListName: T("commands/moderation:note.subcommandListName"),
    subcommandListDescription: T("commands/moderation:note.subcommandListDescription"),
    subcommandRemoveName: T("commands/moderation:note.subcommandRemoveName"),
    subcommandRemoveDescription: T("commands/moderation:note.subcommandRemoveDescription"),
    ...
    caseIdFieldDescription: T("commands/moderation:note.caseIdFieldDescription"),
    ...
    listEntry: FT<{ id: string; mod: string; note: string }>("commands/moderation:note.listEntry"),
  ...
  Errors: {
    ...
    warnSettingsNotConfigured: T("commands/moderation:errors.warnSettingsNotConfigured"),
    ...
    invalidLevel: FT<{ max: string }>("commands/moderation:errors.invalidLevel"),
